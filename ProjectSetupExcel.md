# Steps to set up your GCP project for using the Google Sheets API:
...
Make sure to provide the access of the google spreadsheet to the Email generated through `Service Accounts`
